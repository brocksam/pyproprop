...
def processed_property(name, **kwargs):
    ...
    **kwargs
    ...
    def check_less_than(self, value):
        ...
        check_comparison(self, value, less_than, "less than", less_than_lambda)
    ...
    def check_at_least(self, value):
        ...
        check_comparison(self, value, at_least, "at least", at_least_lambda)

    def check_at_most(self, value):
        def at_most_lambda(val_1, val_2):
            return val_1 <= val_2

        check_comparison(self, value, at_most, "at most", at_most_lambda)
